...
| NodeSeek | `nodeseek` | `nodeseek` | 签到 | 浏览器 |
| V2EX | `v2ex` | `v2ex` | 签到 | 浏览器 |
| 奶昔论坛 | `naixi` | `naixi` | 签到 | 浏览器 |
| 吾爱破解 | `pojie52` | `pojie52` | 签到 | 浏览器 |
| NodeLoc | `nodeloc` | `nodeloc` | 签到 | 浏览器 |
| PCEVA | `pceva` | `pceva` | 签到 | 浏览器 |
| Chiphell | `chiphell-com` | `chiphell` | 保活 | 浏览器 |
| 恩山无线论坛 | `right` | `right` | 签到 | 浏览器 |
| 卡饭论坛 | `kafan` | `kafan` | 签到 | 浏览器 |
| 阡陌居 | `qianmoju` | `qianmoju` | 签到 | 浏览器 |
...
| 站点 | Key | 类型 | 方式 |
|------|-----|------|------|
| Audiences | `audiences-me` | 保活 | 浏览器 |
| BTSCHOOL | `pt-btschool-club` | 保活 | 浏览器 |
| CarPT | `carpt-net` | 签到 | 浏览器 |
| FARMM / 0ff | `pt-0ff-cc` | 签到 | 浏览器 |
| HHanClub | `hhanclub-net` | 签到 | 浏览器 |
| HDDolby | `hddolby-com` | 签到 | 浏览器 |
| HDFans | `hdfans-org` | 签到 | 浏览器 |
| HDHome | `hdhome-org` | 签到 | 浏览器 |
| HDSky | `hdsky-me` | 保活 | 保活访问 |
| OpenCD | `open-cd` | 保活 | 保活访问 |
| OurBits | `ourbits-club` | 保活 | 保活访问 |
| Piggo | `piggo-me` | 保活 | 浏览器 |
| PTTime | `pttime-org` | 保活 | 浏览器 |
| PterClub | `pterclub-net` | 签到 | 浏览器 |
